...
public interface PromotionService {
	...
	public List getPromotionByPage(int shop_id) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List getAllPromByPage() throws Exception;
	...
	public boolean judgeValidity(Date start, Date end) throws Exception;
