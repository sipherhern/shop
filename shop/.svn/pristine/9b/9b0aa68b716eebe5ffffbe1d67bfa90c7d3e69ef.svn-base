...
public class CollectServiceImpl extends BaseServiceImpl implements
	...
	@Override
	public List<Map<String, Object>> getProdCollectPage(int cust_id, int pageIndex, int pageSize)
			throws Exception {
		...
		try {
			List<Map<String, Object>> result = this.find(hql, pageIndex, pageSize, cust);
			return result;
		} catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	@Override
	public List<Map<String, Object>> getShopCollectPage(int cust_id, int pageIndex, int pageSize)
			throws Exception {
		Map<String, Object> cust = new HashMap<String, Object>();
		cust.put("custId", cust_id);
