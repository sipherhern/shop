...
public class BaseServiceImpl<T> implements BaseService<T> {
	 ...
	 * 保存对象
	 */
	public void save(T entity) throws ShopException {
	 ...
	 * 删除对象
	 */
	public void delete(T entity) throws ShopException {
	 ...
	 * 更新
	 */
	public void update(T entity) throws ShopException {
	 ...
	 * 合并
	 */
	public void merge(T entity) throws ShopException {
	 ...
	 */
	@Override
	public void persist(T entity) throws ShopException {
		this.persist(entity);
	}
	 ...
	 * 保存或更新
	 */
	public void saveOrUpdate(T entity) throws ShopException {
	...
	@Override
	public PageSet<T> findAllRecordAndDivPage(int pageSize, String pageIndex,
			String hql) {
		int startpage;
		if (pageIndex == null) {
			startpage = 1;
		} else {
			startpage = Integer.parseInt(pageIndex);
		}
		PageSet<T> pageSet = new PageSet<T>();
		int allRow = this.getAllRowCount(hql);
		int totalPage = PageSet.countTotalPage(pageSize, allRow);
		int pageStartRow = PageSet.countOffset(pageSize, startpage);
		...
		final int currentPage = PageSet.countCurrentPage(startpage);

		List<T> list = this.getAllRecordAndDivPage(hql, offset, length);
		pageSet.setNumPerPage(pageSize);
		pageSet.setCurrentPage(currentPage);
		pageSet.setAllRow(allRow);
		pageSet.setTotalPage(totalPage);
	 ...
	 * 保存对象
	 */
	public Integer save2(T entity) throws ShopException {
