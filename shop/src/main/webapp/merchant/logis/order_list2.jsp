...
<e:override name="content_right">
	...
	<ul class="breadcrumb">
		...
		<li><i class="icon-home"></i> <a href="index.html">物流</a> <i
			class="icon-angle-right"></i></li>
		<li><a href="#">发货</a></li>
	</ul>
		...
		<div class="box span12">
			<div class="box-content">
				...
				<ul class="nav nav-pills nav-justified">
					...
					<li class="#"><a href="#"><span>发货中的订单&nbsp;</span> <i
							class="#">|</i></a></li>

					<li><a href="#"><span>等待发货的订单&nbsp;</span><span
							class="label label-important">1</span><i class="#">|</i></a></li>

					<li><a href="#"><span>已发货的订单&nbsp;</span><em>0</em><i
							class="#">|</i></a></li>

					<li><a href="#"><span>未发货的订单&nbsp;</span><span
							class="label label-important">1</span><i class="#">|</i></a></li>

					<li><a href="#"><span>被取消的订单&nbsp;</span><em>0</em><i
							class="#">|</i></a></li>
				</ul>
				<hr>
					...
					<fieldset>
						...
						<div class="span4">
							<div class="control-group">
								<label class="control-label" for="typeahead">收件人名称 </label>
								<div class="controls">
									<input type="text">
								...
								<table
									...
									<thead>
										...
										<tr class="toolbar toolbar-top">
											<td colspan="7"><input
													id="All" type="checkbox">全选&nbsp;&nbsp; <input
												type="button" value="关闭交易" /> <input type="button"
												value="发货" /></td>
										</tr>
									</thead>
    ...
    last     ">
											...
											<td class="trade-status td-last" rowspan="2"><br>
												<p>等待买家付款
												<p />
													<a href="###" target="_blank">详情</a> <br>
												<p>买家已付款
												<p />
													<a href="###" target="_blank">详情</a><br></td>
											<td class="trade-operate td-last" rowspan=" 2 "><input
												type="button" value="关闭交易" /> <input type="button"
												value="发货" /></td>
										</tr>
									</tbody>
    ...
    last     ">
											...
											<td class="trade-status td-last" rowspan="2"><br>
												<p>等待买家付款
												<p /> <a href="###" target="_blank">详情</a> <br>
												<p>买家已付款
												<p /> <a href="###" target="_blank">详情</a><br></td>
    ...
    last     order-last">
											...
											<td class="trade-status" rowspan="1"><br>
												<p>等待买家付款
												<p /> <a href="###" target="_blank">详情</a> <br>
												<p>买家已付款
												<p /> <a href="###" target="_blank">详情</a><br></td>
    ...
    last     order-last">
											...
											<td class="trade-status" rowspan="1">
												...
												<p>买家已付款
												<p /> <a href="###" target="_blank">详情</a><br>
											</td><td class="trade-operate td-last" rowspan=" 2 "><input
												type="button" value="关闭交易" /> <input type="button"
												value="发货" /></td></tr></tbody><tbody data-isarchive="true" data-orderid="1025137385128843"
										data-status="TRADE_FINISHED"
    ...
    last     order-last">
											...
											<td class="trade-status" rowspan="1">
												...
												type="button" value="关闭交易" /> <input type="button"
												value="发货" /></td></tr></tbody><tbody data-isarchive="true" data-orderid="1019964738778843"
										data-status="TRADE_FINISHED"
    ...
    last     order-last">
											...
											<td class="price" title="198.00"><i class="special-num">198.00</i></td>
    ...
    last     order-last">
											...
											<td class="trade-status" rowspan="1">
												...
												type="button" value="关闭交易" /> <input type="button"
												value="发货" /></td></tr></tbody><tbody data-isarchive="true" data-orderid="1011094913848843"
										data-status="TRADE_CLOSED"
    ...
    last     order-last">
											...
											<td class="trade-status" rowspan="1">
												...
												type="button" value="关闭交易" /> <input type="button"
												value="发货" /></td></tr></tbody><tbody data-isarchive="true" data-orderid="997276735048843"
										data-status="TRADE_FINISHED"
    ...
    last     order-last">
											...
											<td class="price" title="699.00"><i class="special-num">699.00</i></td>
